<template>
    <div id="sample">
        ...
        <div>
            ...
            <textarea id="mySavedModel" v-model="mySaveModel" style="width: 800px; height: 400px;">
    </textarea>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data(){
            return{
                ...
                down:true,
                myDiagram:'',
                mySaveModel:{ "class": "go.GraphLinksModel",
                    "nodeDataArray": [
                        {
...
//console.log(this.myDiagram.nodeTemplate);
       ...
       this.myDiagram.linkTemplate =
        ...
        //          console.log(this.mySaveModel);
        this.myDiagram.model = go.Model.fromJson(this.mySaveModel);
        this.loop(this.myDiagram);  // animate some flow through the pipes
    },


     loop:function(myDiagram) {
         //console.log(this);
         var that=this;
        ...
        setTimeout(function() {
            ...
            diagram.links.each(function(link) {
                ...
                if (that.down) that.opacity = that.opacity - 0.01;
                else that.opacity = that.opacity + 0.003;
                if (that.opacity <= 0) { that.down = !that.down; that.opacity = 0; }
                if (that.opacity > 1) { that.down = !that.down; that.opacity = 1; }
                shape.opacity = that.opacity;
            });
     ...
     onSelectionChanged:function(e) {
        ...
        var data = node.data;
         that.image = document.querySelector('#Image');
